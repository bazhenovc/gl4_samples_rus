...
class md5load
{
	...
	public:
        ...
        //void Run(std::ifstream &theCardFile);
     ...
     //private:
		...
		static void  Quat_computeW (quat4_t q);
		static void  Quat_rotatePoint (const quat4_t q, const vec3_t in, vec3_t out);
		static void  Quat_multQuat (const quat4_t qa, const quat4_t qb, quat4_t out);
		static void  Quat_normalize (quat4_t q);
		static void  Quat_multVec (const quat4_t q, const vec3_t v, quat4_t out);
		static void  Quat_slerp (const quat4_t qa, const quat4_t qb, float t, quat4_t out);
		static float Quat_dotProduct (const quat4_t qa, const quat4_t qb);
